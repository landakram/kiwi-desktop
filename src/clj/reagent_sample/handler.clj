  ...
  (html
   [:html
    [:head
     ...
     [:script {:src "https://use.fontawesome.com/d46783d42c.js"}]
    ...
    [:body
     ...
     (include-js "https://cdnjs.cloudflare.com/ajax/libs/markdown-it/5.1.0/markdown-it.js")
     ...
     [:script "reagent_sample.core.init()"]]]))
